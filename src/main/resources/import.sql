...
INSERT INTO users (id, role_id, username, password, first_name, last_name, email, session_key, is_active) VALUES (1, 1, 'username1', 'password1', 'samplename1', 'lastname1', 'sample@gmail1.com', NULL, true);

INSERT INTO users (id, role_id, username, password, first_name, last_name, email, session_key, is_active) VALUES (2, 2, 'username2', 'password12', 'samplename12', 'lastname12', 'sample@gmail2.com', NULL, true);
...
INSERT INTO users (id, role_id, username, password, first_name, last_name, email, session_key, is_active) VALUES (9, 4, 'username9', 'password19', 'samplename10', 'lastname19', 'sample@gmail9.com', NULL, true);

INSERT INTO users (id, role_id, username, password, first_name, last_name, email, session_key, is_active) VALUES (10, 5, 'username10', 'password12', 'samplename11', 'lastname10', 'sample@gmail0.com', NULL, true);

INSERT INTO users (id, role_id, username, password, first_name, last_name, email, session_key, is_active) VALUES (11, 2, 'username11', 'password11', 'samplename12', 'lastname11', 'sample@gmail20.com', NULL, true);
