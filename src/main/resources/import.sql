...
INSERT INTO users (id, role_id, username, password, first_name, last_name, contact_no, address, email, is_active, session_key, created_at, updated_at, deleted_at) VALUES (2, 2, 'username2', '$2a$10$LQaQLkSGHqKeuUiZMnHr3uB3r/S0UYDK.zCTSTlAQOlKyOBzl5TSy', 'samplename12', 'lastname12', '09231423123', '10. p zamora st. sta. lucia novaliches qc', 'sample12@gmail.com', false, null, NOW(), NOW(), null);

INSERT INTO users (id, role_id, username, password, first_name, last_name, contact_no, address, email, is_active, session_key, created_at, updated_at, deleted_at) VALUES (3, 3, 'username3', '$2a$10$LQaQLkSGHqKeuUiZMnHr3uB3r/S0UYDK.zCTSTlAQOlKyOBzl5TSy', 'samplename13', 'lastname13', '02-412134', '10. p zamora st. sta. lucia novaliches qc', 'sample13@gmail.com', true, null, NOW(), NOW(), null);

INSERT INTO users (id, role_id, username, password, first_name, last_name, contact_no, address, email, is_active, session_key, created_at, updated_at, deleted_at) VALUES (4, 4, 'username4', '$2a$10$LQaQLkSGHqKeuUiZMnHr3uB3r/S0UYDK.zCTSTlAQOlKyOBzl5TSy', 'samplename14', 'lastname14', '09123245621', '10. p zamora st. sta. lucia novaliches qc', 'sample14@gmail.com', false, null, NOW(), NOW(), null);

INSERT INTO users (id, role_id, username, password, first_name, last_name, contact_no, address, email, is_active, session_key, created_at, updated_at, deleted_at) VALUES (5, 5, 'username5', '$2a$10$LQaQLkSGHqKeuUiZMnHr3uB3r/S0UYDK.zCTSTlAQOlKyOBzl5TSy', 'samplename15', 'lastname15', '02-421322', '10. p zamora st. sta. lucia novaliches qc', 'sample15@gmail.com', true, null, NOW(), NOW(), null);

INSERT INTO users (id, role_id, username, password, first_name, last_name, contact_no, address, email, is_active, session_key, created_at, updated_at, deleted_at) VALUES (1, 1, 'username1', '$2a$10$LQaQLkSGHqKeuUiZMnHr3uB3r/S0UYDK.zCTSTlAQOlKyOBzl5TSy', 'samplename1', 'lastname1', '09234123412', '10. p zamora st. sta. lucia novaliches qc', 'sample11@gmail.com', false, null, NOW(), NOW(), null);
